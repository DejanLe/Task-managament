...
class ManagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create management" do
    assert_difference('Management.count') do
      post managements_url, params: { management: { project_description: @management.project_description, project_name: @management.project_name } }
    end
  ...
  test "should update management" do
    patch management_url(@management), params: { management: { project_description: @management.project_description, project_name: @management.project_name } }
